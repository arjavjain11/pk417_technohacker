        ...
        <form role="form" method="post" action="home.php?edit_profile=<?php echo $userid;?>"
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="" name="name" placeholder="Your full Name">
            </div>
            <div class="form-group">
              <label for="exampleInput2">Email</label></label>
              <input type="email" class="form-control" id="" name="email" placeholder="Your Email">
            </div>

            <div class="form-group">
              <label for="exampleInput3">Mobile No</label>
              <input type="number" class="form-control" id="" name="phone" placeholder="Mobile No">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="exampleInput5">Farmregion</label>
              <select class="custom-select" id="validationCustom" required>
